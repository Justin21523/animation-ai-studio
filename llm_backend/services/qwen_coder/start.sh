#!/bin/bash
#
# Qwen2.5-Coder-7B vLLM Service Startup Script
...
# MODEL_PATH="${MODEL_PATH:-/mnt/c/AI_LLM_projects/ai_warehouse/models/llm/qwen/Qwen2.5-Coder-7B-Instruct}"
...
echo "========================================="
echo "🚀 Starting Qwen2.5-Coder-7B vLLM Service"
