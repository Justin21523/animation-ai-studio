...
- ✅ **Translation Support:** LLMProvider API and GPT API for high-quality subtitle translation
...
translation:
  enabled: true
  translator: llm_provider   # or gpt
  source_lang: en
  target_languages:
    - zh  # Chinese
    - ja  # Japanese
...
|---------|-------|---------|------|
| LLMProvider API | ~5s per 20 segments | Excellent | Moderate |
...
echo $LLM_VENDOR_API_KEY  # Should show your key
...
# LLMVendor LLMProvider API (for translation)
export LLM_VENDOR_API_KEY="sk-ant-..."
```
