...
Features:
  ...
  - Subtitle translation (LLMProvider or OpenAI GPT APIs)
...
Usage:
  ...
  python scripts/automation/scenarios/subtitle_automation.py \
    ...
    --source-lang en \
    --target-lang zh-TW \
    --translation-engine llm_provider
...
class LLMProviderTranslator:
    """LLMProvider API translator for subtitle translation."""

    def __init__(self, api_key: Optional[str] = None, max_retries: int = 3):
        """
        Initialize LLMProvider translator.
...
def translate_subtitles(
    ...
    source_lang: str,
    target_lang: str,
    translation_engine: str = 'llm_provider',
    batch_size: int = 20,
) -> bool:
    """
    ...
    Args:
        ...
        source_lang: Source language code
        target_lang: Target language code
        translation_engine: Translation engine ('llm_provider' or 'gpt')
    ...
    try:
        ...
        if translation_engine == 'llm_provider':
            translator = LLMProviderTranslator()
...
def main():
    ...
    parser.add_argument('--translation-engine', type=str, default='llm_provider',
                       choices=['llm_provider', 'gpt'],
                       help='Translation engine (default: llm_provider)')
