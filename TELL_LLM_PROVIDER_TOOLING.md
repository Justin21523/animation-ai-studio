# 🎯 如何告訴新的 LLMProvider Tooling 會話

**當您在另一個 WSL 視窗開始新的 LLMProvider Tooling 會話時，複製貼上以下內容：**

---

## 📋 開場訊息 (複製這段給 LLMProvider Tooling)
...
參考文檔：
- LLM_PROVIDER.md (Agent workflow範例)
...
- `LLM_PROVIDER.md` 中的 workflow 範例

---

## 🚀 實現優先順序

告訴 LLMProvider Tooling 按這個順序工作：
...
**準備好了嗎？在新的 WSL 視窗打開 LLMProvider Tooling，複製上面的開場訊息開始吧！** 🚀
